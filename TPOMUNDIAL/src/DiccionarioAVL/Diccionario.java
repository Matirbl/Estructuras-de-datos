...
public class Diccionario {
    ...
    private void listaElementoRec(NodoDiccionario n, Lista datos) {
        ...
        if (n != null) {
            ...
            datos.insertar(n.getElem(), datos.getLongitud() + 1);
    ...
    public Lista listarClaves() {
        ...
        listarClaves(this.raiz, claves);
        return claves;
    }

    private void listarClaves(NodoDiccionario n, Lista claves) {
        //recorrido inorden muestra ordenadamente el arbol
        if (n != null) {
            listarClaves(n.getIzq(), claves);
            claves.insertar(n.getClave(), claves.getLongitud() + 1);
            listarClaves(n.getDer(), claves);
        }
    }
    ...
    public String toString() {
        String acum = "";
        if (this.raiz != null) {
            acum += toStringRec(this.raiz);
        }
        return acum;
    }

    private String toStringRec(NodoDiccionario nodoActual) {
        String listaString = "";
        if (nodoActual != null) {
            if (nodoActual.getIzq() != null) {
                listaString += toStringRec(nodoActual.getIzq());
            }
            listaString += visita(nodoActual, nodoActual.getIzq(), nodoActual.getDer());
            if (nodoActual.getDer() != null) {
                listaString += toStringRec(nodoActual.getDer());
            }
        }
        return listaString;
    }
    ...
    public String visita(NodoDiccionario nodoActual, NodoDiccionario hijoIzq, NodoDiccionario hijoDer) {
        //precondicion n es distinto de null
        String salida = "Nodo Actual: " + nodoActual.getElem().toString(), izq, der;
        ...
        if (hijoIzq != null && hijoDer != null) {
            ...
            if (nodoActual.getIzq() == null) {
                ...
                izq = hijoIzq.getElem().toString();
            }
            if (nodoActual.getDer() == null) {
                der = "vacio";
            } else {
                der = hijoDer.getElem().toString();
            }

            salida += " tiene el hijo izq: " + izq
                    + " e hijo der: " + der + "\n";
        }
        return salida;
    }
